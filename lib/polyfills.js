export const templateShadowRootPolyfill = `/**
* @license
...
const templateShadowRootPolyfillBytes = new TextEncoder().encode(templateShadowRootPolyfill);

export function templateShadowRootPolyfillResponse() {
  return new Response(templateShadowRootPolyfillBytes, {
    status: 200,
    headers: {
      'content-type': 'text/javascript',
      'content-length': templateShadowRootPolyfillBytes.byteLength
    }
  });
}